...
public class KafkaConfiguration {
    ...
    @Bean
    public NewTopic createStockLowSucessEvent() {
        return new NewTopic("low-stock-sucess", 1, (short) 1);
    }

    @Bean
    public NewTopic createStockLowRejectedEvent() {
        return new NewTopic("low-stock-rejected", 1, (short) 1);
    }
